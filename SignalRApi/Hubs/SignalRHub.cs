...
namespace SignalRApi.Hubs
{
    public class SignalRHub: Hub
    {
        ...
        public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService = null, IMoneyCaseService moneyCaseService = null, IMenuTableService menuTableService = null)
        {
        ...
        public async Task SendStatistic()
        {
            ...
            var value3 = _categoryService.TActivateCategoryCount();
            await Clients.All.SendAsync("ReceiverActiveCategoryCount", value3);

            var value4 = _categoryService.TDeactivateCategoryCount();
            await Clients.All.SendAsync("ReceiverDeactivateCategoryCount", value4);
